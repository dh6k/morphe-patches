...
public final class HeliumProcessKeepAliveService extends Service {
    ...
    private static final String TEXT = "Reduces likelihood of browser extension runtime reclaim";
    ...
    private synchronized boolean promote() {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (manager == null) { Log.w(TAG, "Notification manager unavailable"); return false; }
        ...
        foregroundStarted = true; return true;
        } catch (RuntimeException e) { Log.e(TAG, "Foreground notification setup failed", e); return false; }
    }

    @Override public void onCreate() { super.onCreate(); promote(); }
    @Override public int onStartCommand(Intent intent, int flags, int startId) { if (promote()) return START_STICKY; stopSelf(startId); return START_NOT_STICKY; }
