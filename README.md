...
> **[v1.6.0-dev.4](https://github.com/dh6k/morphe-patches/releases/tag/v1.6.0-dev.4)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;7 patches total
<details open>
...
| [Titanium keep-alive manifest](#titanium-keep-alive-manifest) | Declares one safe foreground service. |  |
